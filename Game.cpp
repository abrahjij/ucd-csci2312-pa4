...
namespace Gaming {
    ...
    bool Game::isLegal(const ActionType &ac, const Position &pos) const {
        ...
        switch (ac) { //each case is the position in the surroundings array, checking to see if the moves leave you inside of the __grid
            case NW:
                x--;
                y--;
                break;
            ...
            case W:
                ...
                break;
            case STAY:
                return true; //ac == STAY, totally cool
            case E:
                y++;
                break;
            case SW:
    ...
    const Position Game::move(const Position &pos, const ActionType &ac) const {
        if (!isLegal(ac, pos))
            return pos;
        int x = pos.x, y = pos.y;
        switch (ac) { //each case is the position in the surroundings array, and since it has to be valid, we will move
            case NW:
                x--;
                y--;
                break;
